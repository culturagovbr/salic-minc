...
const PERFIL_SUPERINTENDENTE_DE_VINCULADA = 153;
const PERFIL_PRESIDENTE_DE_VINCULADA = 154;
const PERFIL_PARECERISTA = 94;
const PERFIL_COORDENADOR_DE_PARECER = 93;
...
const ORGAO_SEFIC_DEIPC_CGEFI = 272;
...
const TP_DILIGENCIA_READEQUACAO_PARECERISTA = 179;
const TP_DILIGENCIA_READEQUACAO_TECNICO = 171;

export default {
    PERFIL_SUPERINTENDENTE_DE_VINCULADA,
    PERFIL_PRESIDENTE_DE_VINCULADA,
    ...
    ORGAO_SUPERIOR_SAV,
    ORGAO_SAV_CAP,
    ORGAO_GEAAP_SUAPI_DIAAPI,
    ORGAO_SEFIC_DEIPC_CGEFI,
    ST_ATENDIMENTO_DEFERIDA,
    ...
    SI_ENCAMINHAMENTO,
    TP_DILIGENCIA_READEQUACAO_PARECERISTA,
    TP_DILIGENCIA_READEQUACAO_TECNICO,
};
