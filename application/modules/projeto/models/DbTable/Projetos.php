...
/**
 * @todo Mover todas os métodos e alterar todas as refer&ecirc;ncias para da antiga classe para essa.
 */
    ...
    public function obterProjetoIncentivoCompleto($idPronac, $where = [])
    {
        ...
        $sql->from(
            ...
            [
                ...
                new Zend_Db_Expr("sac.dbo.fnVlAutorizadoACaptar(a.idPronac) as vlTotalAutorizado"),
