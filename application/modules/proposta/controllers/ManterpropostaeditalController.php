    ...
    public function validarEnvioPropostaAoMinc($idPreProjeto)
    {
        ...
        if (count($rsMovimentacao) > 0) {
            if ($rsMovimentacao->Movimentacao != 95) {
                ...
                $arrResultado['movimentacao']['msg'] = "A Proposta Cultural encontra-se no Minist&eacute;rio do Turismo";
            }
        }
        ...
        //VERIFICA SE O PROPONENTE ESTA VINCULADO
            ...
            if (count($regularidade) > 0) {
                if ($regularidade[0]->Habilitado == "S") {
                    ...
                    $arrResultado['regularidadeproponente']['msg'] = "Proponente em situa&ccedil;&atilde;o REGULAR no Minist&eacute;rio do Turismo - <font color='green'>OK</font>";
                } else {
                    $arrResultado['erro'] = true;
                    $arrResultado['regularidadeproponente']['erro'] = true;
                    $arrResultado['regularidadeproponente']['msg'] = "Proponente em situa&ccedil;&atilde;o IRREGULAR no Minist&eacute;rio do Turismo - <font color='red'>PENDENTE</font>";
                }
            } else {
                $arrResultado['regularidadeproponente']['erro'] = false;
                $arrResultado['regularidadeproponente']['msg'] = "Proponente em situa&ccedil;&atilde;o REGULAR no Minist&eacute;rio do Turismo - <font color='green'>OK</font>";
        ...
        if (!empty($idPreProjeto) && $valida == "s") {
            ...
            if ($idTecnico) {
                ...
                try {
                    ...
                    parent::message("A Proposta foi enviado com sucesso ao Minist&eacute;rio do Turismo!", "/proposta/manterpropostaedital/enviar-proposta?idPreProjeto=" . $idPreProjeto . $edital, "CONFIRM");
                    die();
                } catch (Exception $e) {
                    parent::message("O Projeto n&atilde;o foi enviado ao Minist&eacute;rio do Turismo!", "/proposta/manterpropostaedital/enviar-proposta?idPreProjeto=" . $idPreProjeto . $edital, "ERROR");
                    die();
                }
            } else { //fecha IF se encontrou tecnicos para enviar a proposta
                parent::message("A Proposta n&atilde;o foi enviado ao Minist&eacute;rio do Turismo. Técnico n&atilde;o localizado", "/proposta/manterpropostaedital/enviar-proposta?idPreProjeto=" . $idPreProjeto . $edital, "ERROR");
                die();
            }
        } else {
            parent::message("A Proposta n&atilde;o foi enviado ao Minist&eacute;rio do Turismo.", "/proposta/manterpropostaedital/enviar-proposta?idPreProjeto=" . $idPreProjeto . $edital, "ERROR");
        }
    }
