...
class GerartermodeaprovacaoController extends MinC_Controller_Action_Abstract
{
    ...
    {
        $this->view->title = "Salic - Sistema de Apoio �s Leis de Incentivo � Cultura"; // titulo da pagina
        ...
        } elseif (in_array($this->codOrgao, $this->arrCodOrgaosSAV)) {
    ...
    //TRATAMENTO CASO NENHUMA DAS CONDI��ES SEJAM ATENDIDAS
    ...
    {
        parent::message("O(s) projeto(s) informado(s) Não atende(m) �s condi��es necess�rias para ser(em) impresso(s) no Termo de Decis�o.", "gerartermodeaprovacao/", "ALERT");
    }
    ...
    public function gerarpdfAction()
    {
        ...
        if ($this->tipoProjeto == "readequacao") {
            ...
            foreach ($rsProjetosAprovadosReadequacao as $dadosresultado) {
                ...
                $pautaAprovadosReadequacao[$ct1]['TipoParecer'] = 'Readequa��o';
        ...
        if ($this->tipoProjeto == "readequacao") {
            ...
            foreach ($rsProjetosIndeferidosReadequacao as $dadosresultado) {
                ...
                $pautaIndeferidosReadequacao[$ct1]['TipoParecer'] = 'Readequa��o';
