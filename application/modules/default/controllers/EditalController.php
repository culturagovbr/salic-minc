...
//        $this->view->criterioavaliacao = $criterioAvaliacao;
    ...
    public function deletarTextoEditalAction()
    {
        ...
        if (($idTextoEdital == '') || ($idEdital == '')) {
            parent::message('Texto do Edital exclu�do com sucesso!', 'edital/montagem-edital/idEdital/'.$idEdital, 'ERROR');
        }
        ...
        try {
            $db->beginTransaction();
            //deleta o criterio de avalia��o
            $modelEditalFinal->delete($where);

            $db->commit();
            parent::message('Texto do Edital exclu�do com sucesso!!', 'edital/montagem-edital/idEdital/'.$idEdital, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
...
//        $this->view->formapagamento = $formaPagamento;
    ...
    public function moduloseditalAction()
    {
        ...
        // validar se existe o Edital ou � do propriet�rio
        $edital = $modelEdital->buscar(array('idEdital = ?' => $idEdital));
        if (count($edital) == 0) {
            parent::message('Edital Não encontrado ou Não pertence a esse org�o!', 'edital/', 'ALERT');
        }
...
//        $listaMunicipios = $modelMunicipios->buscar(array(), array('idUFIBGE','Descricao'));
    ...
    public function novoModuloAction()
    {
        ...
        if (count($criterios) == 0) {
            parent::message('Informe os crit�rios de avalia��o!', 'edital/criterios-avaliacao/idEdital/'.$idEdital, 'ALERT');
        }
    ...
    public function atualizaInfoGeralModuloAction()
    {
         ...
         //Recupera as informa��es: nome do modulo a ser cadastrado, e o id do Edital a ser associado.
        $idEdital           = $this->_request->getParam('idEdital');
        $idModulo           = $this->_request->getParam('idModulo');
        ...
        try {
            ...
            $db->commit();
            parent::message('Informa��es gerais atualizado com sucesso!', 'edital/informacoes-modulo/idEdital/'.$idEdital.'/idModulo/'.$idModulo, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            xd($exc);
            parent::message('Erro ao atualizar as informa��es gerais', 'edital/informacoes-modulo/idEdital/'.$idEdital.'/idModulo/'.$idModulo, 'ERROR');
        }
    }
    ...
    public function salvaCriterioParticipacaoAction()
    {
        ...
        try {
            ...
            $db->commit();
            parent::message('Crit�rio de Participa��o cadastrado com sucesso!', 'edital/criterios-participacao/idEdital/'.$idEdital.'/idModulo/'.$idModulo.'/idCategoria/'.$idCategoria, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            xd($exc->getMessage());
            parent::message('Erro ao cadastrar os Crit�rios de Participa��o', 'edital/criterios-participacao/idEdital/'.$idEdital.'/idModulo/'.$idModulo.'/idCategoria/'.$idCategoria, 'ERROR');
        }
    }
    ...
    public function deletarCriterioParticipacaoAction()
    {
        ...
        try {
            ...
            $db->commit();
            parent::message('Crit&eacute;rio de Participacao exclu�do!', 'edital/criterios-participacao/idEdital/'.$idEdital.'/idModulo/'.$idModulo.'/idCategoria/'.$idCategoria, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
    ...
    public function deletarFormaPagamentoAction()
    {
        ...
        if (($idFormaPagamento == '') || ($idEdital == '')) {
            parent::message('Forma de Pagamento exclu�do com sucesso!', 'edital/forma-pagamento/idEdital/'.$idEdital.'/idModulo/'.$idModulo.'/idCategoria/'.$idCategoria, 'ERROR');
        }
        ...
        try {
            ...
            $db->commit();
            parent::message('Forma de Pagamento exclu�da com sucesso!', 'edital/forma-pagamento/idEdital/'.$idEdital.'/idModulo/'.$idModulo.'/idCategoria/'.$idCategoria, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            xd($exc->getMessage());
    ...
    public function salvaModuloAction()
    {
        ...
        try {
            $db->beginTransaction();
            //Cria uma inst�ncia do modulo, grava e recupera o id.
            ...
            $db->commit();
            parent::message('M�dulo cadastrado com sucesso!', 'edital/modulosedital/idEdital/'. $idEdital, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            parent::message('Erro ao cadastrar m�dulo', 'edital/modulosedital/idEdital/' . $idEdital, 'ERROR');
        }
    }
    ...
    public function atualizaInfoGeralCategoriaAction()
    {
        ...
        try {
            ...
            $db->commit();
            parent::message('Informa��es gerais da categoria atualizado com sucesso!', 'edital/informacoes-categoria/idEdital/'.$idEdital.'/idModulo/'.$idModulo.'/idCategoria/'.$idCategoria, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            parent::message('Erro ao atualizar as informa��es gerais da Categoria', 'edital/informacoes-categoria/idEdital/'.$idEdital.'/idModulo/'.$idModulo.'/idCategoria/'.$idCategoria, 'ERROR');
        }
    }
    ...
    public function salvarFluxoEditalAction()
    {
        ...
        try {
            ...
            //Salva a composi��o(�es) que o Edital pode(m) ter
    ...
    public function salvarInformacaoGeralAction()
    {
        ...
        try {
            ...
            //Atualizando informa��es na tabela tbEdital
            ...
            if (isset($tipoparticipacao)) {
                ...
                foreach ($tipoparticipacao as $key => $tpart) {
                    $dadosTipoParticipacao = array(
                        ...
                        'qtParticipacao'    => $qtTipoParticipacao[$tpart-1] //Array de Tipos de Participa��o come�a com 0. Array de Qntd come�a com 1. Por isso a diminui��o do valor para pegar o valor correspondente.
                    );
            ...
            parent::message('Informa��es gerais do Edital com sucesso!', 'edital/criterios-avaliacao/idEdital/' . $idEdital, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            xd($exc->getMessage());
            parent::message('Erro ao cadastrar as Informa��es gerais do Edital', 'edital/informacao-geral/idEdital/'.$idEdital, 'ERROR');
        }
    }
    ...
    public function salvarcriteriodeavaliacaoAction()
    {
        ...
        try {
            ...
            if ($idCriterioAvaliacao != '') {
                ...
                $msg = 'Crit�rio de avalia��o atualizado com sucesso!';
            } else {
                $nEdital->salvarcriterioavaliacao($dados);
                $msg = 'Crit�rio de avalia��o cadastrado com sucesso!';
            }
            //Salva o Edital e recupera o ID
    ...
    public function deletarCriterioAvaliacaoAction()
    {
        ...
        if (($idCriterio == '') || ($idEdital == '')) {
            parent::message('Crit�rio de avalia��o exclu�do com sucesso!', 'edital/criterios-avaliacao/idEdital/'.$idEdital, 'ERROR');
        }
        ...
        try {
            ...
            $db->commit();
            parent::message('Crit&eacute;rio de avalia��o exclu�do com sucesso!', 'edital/criterios-avaliacao/idEdital/'.$idEdital, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            parent::message('Erro ao excluir o crit�rio de avalia��o', 'edital/criterios-avaliacao/idEdital/'.$idEdital, 'ERROR');
        }
    }
    ...
    public function buscaCriterioAjaxAction()
    {
        ...
        try {
            if (!$idCriterio) {
                ...
                if (count($criterio) == 0) {
                    $retorno['error'] = utf8_encode('Crit�rio Não encontrado!');
                } else {
    ...
    public function salvarPlanilhaOrcamentariaAction()
    {
        ...
        try {
            ...
            $msg = 'Etapa/Item cadastrado � planilha or�ament�ria com sucesso!';
//            }

            //Salva o Edital e recupera o ID
            $db->commit();
            parent::message('Etapa/Item cadastrado � planilha or�ament�ria com sucesso', 'edital/modulosedital/idEdital/'.$idEdital, 'CONFIRM');
        } catch (Exception $exc) {
            $db->rollBack();
            xd($exc);
            parent::message('Erro ao cadastrar a etapa/item � planilha or�ament�ria.', 'edital/modulosedital/idEdital/'.$idEdital, 'ERROR');
        }
    }
        ...
        try {
            if (!$idPlanOrcEdital) {
                ...
                if (count($planilhaOrcamentaria) == 0) {
                    $retorno['error'] = utf8_encode('�tem/Etapa Não encontrados!');
                } else {
