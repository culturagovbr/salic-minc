...
class ProjetosGerenciarController extends MinC_Controller_Action_Abstract
{
    ...
    public function formDevolverParaAnaliseAction()
    {
        ...
        if ($this->bln_readequacao == "true") {
            echo "<br><br><br><center><font color='red'><b>Este Projeto encontra-se em An&aacute;lise de Readequa��o.</b></font><center>";
    ...
    public function devolverProjetoParaAnaliseAction()
    {
        ...
        try {
            ...
            try {
                ...
                $ProvidenciaTomada = 'Projeto devolvido para An&aacute;lise T&eacute;cnica por Solicitação do Componente.';
    ...
    public function retirarDePautaAction()
    {
        ...
        try {
            ...
            if ($tbRetirarDePauta->alterar($dados, $where)) {
                ...
                // IN&iacute;CIO devolver pra vinculada
                if ($tpAcao == 3) {
                    if ($this->bln_readequacao == "true") {
                        throw new Exception("Este Projeto encontra-se em An&aacute;lise de Readequa��o!");
                    }
                    $arrBusca = array();
                    $arrBusca['p.IdPRONAC = ?']    = $idPronac;
                    $arrBusca['t.stPrincipal = ?'] = 1;
