...
class ErrorController extends Zend_Controller_Action
{
    ...
    public function noauthAction()
    {
        ...
        $this->view->message = 'Voc&ecirc; precisa efetuar login para visualizar este conteúdo.';
    ...
    public function notallowedAction()
    {
        $this->_helper->layout->disableLayout();
        $this->_helper->viewRenderer->setRender('error');
        $this->view->message = 'Voc&ecirc; não tem permissão para acessar este conteúdo.';
    ...
    public function notfoundAction()
    {
        $this->_helper->layout->disableLayout();
        $this->_helper->viewRenderer->setRender('error');
        $this->view->message = 'Página não encontrada.<br /> Voc&ecirc; não possui permissão de acesso ou o link desejado não existe mais no sistema.';
    ...
    public function errorPlanetAction()
    {
        ...
        switch ($errors->type) {
            case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_NO_ROUTE:
                $this->view->message = 'Página não encontrada. Tem certeza que voc&ecirc; digitou o endereço corretamente?';
                break;
