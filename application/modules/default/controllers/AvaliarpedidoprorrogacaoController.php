        ...
        try {
            if (ProrrogacaoModel::DEFERIDO == $this->getRequest()->getParam('analise')) {
                if (empty($opcaoDeferimento) && PerfilModel::TECNICO_DE_ACOMPANHAMENTO == $this->getIdGrupo) {
                    parent::message("Ao dererir, escolha uma das op��es antes de salvar a sua Avalia&Ccedil;&Atilde;o!", "avaliarpedidoprorrogacao/detalhar/prorrogacao/{$idProrrogacao}", "ERROR");
                }
