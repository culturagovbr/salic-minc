...
<div id="menu">
    ...
    <div id="menuContexto">
        ...
        <div id="qm0" class="qmmc sanfona">
            ...
            <a class="no_seta" id="consultarprojetos" href="<?php echo $this->url(array('controller' => 'dadosprojeto', 'action' => 'index')); ?>" target="_new" title="Ir para Consultar Projetos">Consultar Projetos </a>
