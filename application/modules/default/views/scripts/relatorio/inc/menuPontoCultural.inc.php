    ...
    function JSExcluirProposta(idPreProjeto) {
        ...
        <div id="menuContexto">
            ...
            <div id="qm0" class="qmmc">
                <a class="no_seta" href="<?php echo $this->url(array('controller' => 'relatorio', 'action' => 'desembolso')); ?>" title="Desembolso">Desembolso</a>
                <a class="no_seta last" href="<?php echo $this->url(array('controller' => 'relatorio', 'action' => 'pc-regiao-uf-cidade')); ?>" title="Regiao / UF / Cidade">Regiao / UF / Cidade</a>
            </div>
