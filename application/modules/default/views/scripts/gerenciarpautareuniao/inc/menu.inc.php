...
<?php
                ...
                ?>
                    ...
                    <a class="no_seta"  href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciarpautareuniao', 'readequacao' => 'false', 'plenaria' => 'true')); ?>" title="Ir para Plen�ria - Análise inicial">Plen�ria - Análise inicial</a>
            ...
            <?php if ($this->grupoAtivo == 119) { //presidente CNIC ?>
                    <a class="no_seta"  href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciarpresidenteemreuniao', 'readequacao' => 'false', 'plenaria' => 'true')); ?>" title="Ir para Plen�ria - Análise inicial">Plen�ria - Análise inicial</a>
