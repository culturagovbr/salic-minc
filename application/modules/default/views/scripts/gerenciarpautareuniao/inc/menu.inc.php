        ...
        <div id="menuContexto">
            ...
            <div id="qm0" class="qmmc">
                ...
                ?>
                    ...
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciaradministrativo', 'readequacao' => 'false', 'plenaria' => 'false')); ?>" title="Ir para Não submetidos -  An&aacute;lise inicial">Não submetidos - An&aacute;lise inicial</a>
                    <!--<a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciaradministrativo', 'readequacao' => 'true', 'plenaria' => 'false')); ?>" title="Ir para Não submetidos -  readequa��o">Não submetidos - readequa��o</a>-->
...
<?php
                ...
                ?>
                    ...
                    <a class="no_seta"  href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciarpautareuniao', 'readequacao' => 'false', 'plenaria' => 'true')); ?>" title="Ir para Plen�ria - An&aacute;lise inicial">Plen�ria - An&aacute;lise inicial</a>
                    ...
                    <a class="no_seta"  href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciarpautareuniao', 'readequacao' => 'false', 'plenaria' => 'false')); ?>" title="Ir para Não submetidos - An&aacute;lise inicial">Não submetidos - An&aacute;lise inicial</a>
                    <!--<a class="no_seta"  href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciarpautareuniao', 'readequacao' => 'true', 'plenaria' => 'false')); ?>" title="Ir para Não submetidos - readequa��o">Não submetidos - readequa��o</a>-->
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'recursos-nao-submetidos')); ?>" title="Ir para Não submetidos - recursos">Não submetidos - recursos</a>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'readequacoes-nao-submetidas')); ?>" title="Ir para Não submetidos - readequa&ccedil;&otilde;es">Não submetidos - readequa&ccedil;&otilde;es</a>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'paineisdareuniao')); ?>" title="Ir para Painel de Reuni&otilde;es">Painel de Reuni&otilde;es</a>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'projetosvotados')); ?>" title="Ir para Painel de Projetos Votados">Projetos Votados</a>
            ...
            <?php if ($this->grupoAtivo == 119) { //presidente CNIC ?>
                    <a class="no_seta"  href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciarpresidenteemreuniao', 'readequacao' => 'false', 'plenaria' => 'true')); ?>" title="Ir para Plen�ria - An&aacute;lise inicial">Plen�ria - An&aacute;lise inicial</a>
                    <a class="no_seta"  href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'gerenciarpresidenteemreuniao', 'readequacao' => 'false', 'plenaria' => 'false')); ?>" title="Ir para Não submetidos - An&aacute;lise inicial">Não submetidos - An&aacute;lise inicial</a>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'recursos-nao-submetidos')); ?>" title="Ir para Não submetidos - recursos">Não submetidos - recursos</a>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'readequacoes-nao-submetidas')); ?>" title="Ir para Não submetidos - readequa&ccedil;&otilde;es">Não submetidos - readequa&ccedil;&otilde;es</a>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'paineisdareuniao')); ?>" title="Ir para Painel de Reuni&otilde;es">Painel de Reuni&otilde;es</a>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'gerenciarpautareuniao', 'action' => 'projetosvotados')); ?>" title="Ir para Painel de Projetos Votados">Projetos Votados</a>
