        ...
        <div id="menuContexto">
            ...
            <div id="qm0" class="qmmc sanfona">
                ...
                <div class="sanfonaDiv" style="width: 90%; margin-left: 20px;">
                    ...
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'projetos', 'action' => 'documentos-anexados')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Documentos anexados">Documentos anexados</a>
