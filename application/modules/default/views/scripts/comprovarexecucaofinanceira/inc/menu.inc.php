                                ...
                                buttons: {
                                    ...
                                    Sim: function() {
                                        ...
                                        if(idcotacao!='' || iddispensa!='' || idlicitacao!='' || idcontrato!='' ){
                                            ...
                                            $(tr).remove();
                                            janelaAlerta('Exclu�do com sucesso!');
                                        }
...
function outroFornecedor(este){
    ...
    $("#divPerguntaFornecedor").html('Deseja utilizar este fornecedor na comprova��o do pagamento?');
...
<script type="text/javascript">
    var me71 = 'Esse projeto Não possui itens de custo para comprova��o financeira. Favor incluir todos os itens de custo para inclus�o de comprova��o financeira.';
    var me72 = 'Deseja realmente finalizar esse processo? Com essa Confirmação voc� Não poder� mais alterar os dados desse processo.';
    var ag1  = 'Dados obrigat�rios Não informados.';
