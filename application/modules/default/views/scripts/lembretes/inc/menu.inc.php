...
<div id="menu">
	...
	<div id="container">
		...
		<?php
        // pega a vari�vel com o id do pronac via get
		...
		<div id="menuContexto">
			...
			<div id="qm0" class="qmmc">
				...
				<a href="<?php echo $this->url(array('controller' => 'visualizarhistorico', 'action' => 'index')); ?>?pronac=<?php echo $getPronac; ?>" title="Ir para Hist�rico">Hist�rico</a>
