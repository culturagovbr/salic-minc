...
<div id="menu">
    ...
    <div id="container">
        ...
        <script type="text/javascript">
            ...
            function  imprimirProjeto(idPronac)
            {
                ...
                $.ajax({
                    url : '<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'form-imprimir-projeto' ));?>?idPronac='+idPronac,
                    data :
                        {
                        idPronac : idPronac
                    },
  ...
  <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'documentos-anexados')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Documentos anexados">Documentos anexados</a>
<a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'local-realizacao-deslocamento')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Local de realiza&ccedil;&atilde;o/ Deslocamento">Local de realiza&ccedil;&atilde;o/ Deslocamento</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'plano-de-distribuicao')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Plano de distribui&ccedil;&atilde;o">Plano de distribui&ccedil;&atilde;o</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'plano-de-divulgacao')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Plano de divulga&ccedil;&atilde;o">Plano de divulga&ccedil;&atilde;o</a>

                    <?php // if ($this->usuarioInterno) {
            ?>
                    <!--<a href="<?php // echo $this->url(array('controller' => 'cidadao', 'action' => 'historico-encaminhamento')); ?><?php echo $codPronac; ?>" title="Ir para Hist&oacute;rico encaminhamento">Hist&oacute;rico encaminhamento</a>-->
                    <?php
//        } ?>
                </div>
            ...
            ?>
                ...
                <div class="sanfonaDiv" style="display:none;"></div>
                <a href="#" title="An&aacute;lise e Aprovação" class="ancoraAnaliseAprovacao" onclick="return false;">An&aacute;lise e Aprovação</a>
                <div class="sanfonaDiv" style="width: 90%; margin-left: 20px;">
            ...
            ?>
                        <a href="<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'dados-bancarios')); ?><?php echo $codPronac; ?>" title="Ir para Dados banc&aacute;rios">Dados banc&aacute;rios</a>
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'dados-fiscalizacao')); ?><?php echo $codPronac; ?>','conteudo'); return false" title="Ir para Dados da fiscaliza&ccedil;&atilde;o">Dados da fiscaliza&ccedil;&atilde;o</a>
                    <?php
        } ?>
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'readequacoes')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Readequa&ccedil;&otilde;es">Dados das readequa&ccedil;&otilde;es</a>
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'marcas-anexadas')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Marcas Anexadas">Marcas Anexadas</a>
                ...
                <div class="sanfonaDiv" style="width: 90%; margin-left: 20px;">
                    <?php /*if(in_array($this->fnLiberarLinks['FaseDoProjeto'],array('4','5'))  || $this->usuarioInterno){ ?>
                        <a href='#' class="no_seta" onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'prestacao-de-contas')); ?><?php echo $codPronac;?>','conteudo'); return false" title="Ir para Presta&ccedil;&atilde;o de Contas">Presta&ccedil;&atilde;o de contas</a>
                    <?php }*/ ?>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'execucao-receita-despesa')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Execu&ccedil;&atilde;o da receita e despesa">Execu&ccedil;&atilde;o da receita e despesa</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'dados-relacao-pagamentos')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Rela&ccedil;&atilde;o de Pagamentos">Rela&ccedil;&atilde;o de pagamentos</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'relatorio-fisico')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Relat&oacute;rio f&iacute;sico">Relat&oacute;rio f&iacute;sico</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'relatorio-bens-capital')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Rela&ccedil;&atilde;o de bens de capital">Rela&ccedil;&atilde;o de bens de capital</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'pagamentos-por-uf-municipio')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Pagamentos por UF/Munic&iacute;pio">Pagamentos por UF / Munic&iacute;pio</a>
                    <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'pagamentos-consolidados-por-uf-municipio')); ?><?php echo $codPronac;?>','conteudo'); return false"  title="Ir para Pagamentos por UF/Munic&iacute;pio">Pagamentos Consolidados</a>
                    <?php if (in_array($this->fnLiberarLinks['FaseDoProjeto'], array('2','3','4','5')) || $this->usuarioInterno) {
            ?>
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'relatorios-trimestrais')); ?><?php echo $codPronac; ?>','conteudo'); return false"  title="Ir para Relat&oacute;rios trimestrais">Relat&oacute;rios trimestrais</a>
                    <?php
        } ?>
                    <?php if (in_array($this->fnLiberarLinks['FaseDoProjeto'], array('4','5'))  || $this->usuarioInterno) {
            ?>
                        <a href='#' onclick="carregaDados('<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'relatorio-final')); ?><?php echo $codPronac; ?>','conteudo'); return false"  title="Ir para Relat&oacute;rio de cumprimento do objeto">Relat&oacute;rio de cumprimento do objeto</a>
                    <?php
        } ?>
                </div>
            ...
            ?>
                ...
                ?>
                    <a href="<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'remanejamento-menor'), '', true); ?>?idPronac=<?php echo Seguranca::encrypt($this->idPronac); ?>" title="Ir para Remanejamento &le; 20%">Remanejamento &le; 20%</a>
                    <?php
            } ?>
            ...
            ?>
                ...
                ?>
                    ...
                    ?>
                            <a style="margin-left: 10px;" href="<?php echo $this->url(array('module' => 'comprovacao-objeto', 'controller' => 'comprovarexecucaofisica', 'action' => 'relatoriotrimestral', 'idpronac' => Seguranca::encrypt($this->idPronac)), '', true); ?>">Relat&oacute;rio Trimestral</a>
                            <?php
                } ?>

                            <?php if ($this->fnLiberarLinks['RelatorioFinal']) {
                    ?>
                              <a style="margin-left: 10px;" href="<?php echo $this->url(array('module' => 'comprovacao-objeto', 'controller' => 'comprovarexecucaofisica', 'action' => 'etapas-de-trabalho-final', 'idpronac' => Seguranca::encrypt($this->idPronac)), '', true); ?>">Comprovar Realiza&ccedil;&atilde;o do Objeto</a>
                            <?php
                } ?>
                        </div>
                    <?php
                ...
                <?php if ($this->blnProponente) {
            ?>
                    <a class="no_seta" href="<?php echo $this->url(array('controller' => 'cidadao', 'action' => 'form-enviar-arquivo-marca')); ?><?php echo $codPronac; ?>">Marcas</a>
                <?php
        } ?>
                <!--  ==================== FIM - MARCAS ====================  -->
