<?php
/**
 * Helper para verificar se o item est&aacute; disponível para edi&ccedil;ão no remanejamento
 */

class Zend_View_Helper_ItemDisponivelParaEdicaoRemanejamento extends Zend_View_Helper_Abstract
{
    /**
     * Método para verificar se o item est&aacute; disponível para edi&ccedil;ão no remanejamento
     * @access public
