...
class ServicosSEI
{
    ...
    public function wsGerarProcedimento($txSiglaSistema = "INTRANET", $txIdentificacaoServico = "SALIC", $nrIdUnidade = '110000151')
    {
        ...
        //Procedimento
        $Procedimento = array();
        $Procedimento['IdTipoProcedimento'] = '100000520'; #Alysson - C&oacute;digo do Tipo de Processo "Apoio Cultural: Projeto Cultural" em Produ��o;
        ...
        //Observa��es
        #$Procedimento['Observacao'] = 'Observa��es para Teste de Inser&aacute;�o de Dados';
