...
class ComprovacaoObjeto_Model_DbTable_TbCumprimentoObjetoXArquivo extends MinC_Db_Table_Abstract
{
     ...
     * a imagem que est� sendo feito o upload do arquivo no formul�rio
