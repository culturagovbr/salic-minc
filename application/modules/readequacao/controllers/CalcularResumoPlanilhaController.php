...
class Readequacao_CalcularResumoPlanilhaController extends MinC_Controller_Rest_Abstract
{
    ...
    public function indexAction(){
        ...
        if (!$permissao) {
            ...
            $data = $readequacaoService->calcularResumoPlanilha($idPronac, $idTipoReadequacao);
        }
