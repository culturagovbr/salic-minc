<?php
/**
 * Helper para verificar se projeto est&aacute; disponível para adição de itens da readequação da planilha
 */

class Zend_View_Helper_DisponivelParaAdicaoItensReadequacaoPlanilha
{
    /**
     * Método para verificar se o projeto est&aacute; disponível para adição de itens da readequação da planilha
     * @access public
