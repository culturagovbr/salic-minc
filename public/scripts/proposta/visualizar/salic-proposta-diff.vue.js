            ...
            <div v-else-if="Object.keys(dadosAtuais).length > 2">
                <div class="card padding20">
                    <div class="nao-existe-versao-proposta">
                        <h4><i class="material-icons small left">report</i>Não existe versionamento de altera��es para o projeto informado...</h4>
                        <p style="margin-left: 44px">O proponente Não fez altera��es no projeto no prazo estabelecido.</p>
                    </div>
                </div>
