Vue.component('agente-form', {
    ...
    <form id="formulario" >
        ...
        <div v-if="css == true " class="erro"> <h6>Os campos com '*' s�o obrigatorios!</h6></div>
        <fieldset>
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="input-field col s6">
                    ...
                    <label :class="[Erro.Numero ? 'erro': '']" for="last_name">N�mero *</label>
                </div>
                <div class="input-field col s6">
            ...
            <div class="row">
                <div class="col s3">
                    <label :class="[Erro.TipoEndereco ? 'erro': '']">Tipo de Endere�o *</label>
